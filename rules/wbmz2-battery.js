...
function initDevice() {
  ...
  */
  ...
  /*
  Если в хранилище wbmz2_ps.correction пусто, то инициализируем со значением по умолчанию.
  */
    ...
    exitCallback: function (exitCode, capturedOutput) {
      if(!capturedOutput){
        ...
        */
        ...
        /*
        Charge - Ёмкость батареи в мАч (mAh)
        */
        ...
        /*
        Если полученные значения ёмкости меньше 0 и меньше калибровочных значений в хранилище с отрицательным знаком, 
        то вписываем это значение в хранилище wbmz2_ps.correction без отрицательного знака.
        */
        if((charge_mah < 0) && ((-charge_mah) > wbmz2_ps.correction)){
